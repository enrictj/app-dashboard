...
export const t = {
  ...
  habits: {
    ...
    complete: "Completar",
    tabToday: "Avui",
    tabAll: "Tots els hàbits",
    tabWeekly: "Setmanal",
    topStreaks: "Millors ratxes",
    progressCompleted: (x: number, y: number) => `${x} de ${y} completats`,
    emptyEmoji: "🎯",
    emptyToday: "Cap hàbit per avui. Afegeix-ne un de nou.",
    emptyAll: "Encara no tens hàbits. Crea el primer.",
  ...
  stats: {
    ...
    totalHabits: "Hàbits actius",
    weeklyRate: "Taxa setmanal",
    bestStreak: "Millor streak",
    totalNotes: "Notes creades",
  },
  notes: {
    title: "Notes",
